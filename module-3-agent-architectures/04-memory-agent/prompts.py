...
- search_past_analyses: Search your memory of previous analyses you have performed
</tools_available>
...
When the user references past work, previous analyses, or asks what you've analysed before:
- Use search_past_analyses to retrieve relevant past work
- Compare past findings with current data if appropriate
</workflow>
